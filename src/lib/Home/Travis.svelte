...
<svg
  ...
  x="0px"
  y="0px"
  viewBox="0 0 291.1 93.7"
  style="enable-background:new 0 0 291.1 93.7;"
  xml:space="preserve"
  width={`${width}rem`}
  height={`${height}rem`}
>
  <g>
    <g>
      <path
        class="st0"
        id="travis-svg-t"
        d="M25.6,31.4H6.3L8.9,15h57.5l-2.6,16.4H44.5L36,85H17.1L25.6,31.4z"
      />
      <path
        class="st0"
        id="travis-svg-r"
        d="M63.3,33h18.5l-2,13.2h0.6c3.5-8.9,8.8-13.7,16.1-13.7c1.1,0,2.4,0.1,4,0.5L98,48.5c-1.7-0.2-3.2-0.3-4.2-0.3
			c-6.8,0-14.7,2.9-16.7,15.2L73.6,85H55.1L63.3,33z"
      />
      <path
        class="st0"
        id="travis-svg-a"
        d="M95.7,73.2c0-10.5,8.3-15.9,21.8-18.1l7.2-1.4C129,53,130.5,52,131,50l0.1-0.7c0.6-2.4-1-4.1-4.8-4.1
      ...
      <path
        class="st0"
        id="travis-svg-v"
        d="M155,33h18.7l5.4,34.2h0.6l16-34.2h19l-26.1,52H165L155,33z"
      />
      <path
        class="st0"
        id="travis-svg-i"
        d="M220.5,33H239l-8.2,52h-18.5L220.5,33z M231.7,10.2c5.1,0,9.7,4.2,9.7,9.6s-4.6,9.5-9.7,9.5
			c-5.2,0-9.8-4.1-9.8-9.5S226.5,10.2,231.7,10.2z"
      />
      <path
        class="st0"
        id="travis-svg-s"
        d="M240,67.5h16.1c0.2,3.1,1.7,5.5,7.1,5.5c4.2,0,6-1.5,6-3.2c0-1-0.4-2.4-4.5-3.3l-7.3-1.6
...
<style>
  .st0 {
    animation-name: fill-anim, stroke-offset-anim;
